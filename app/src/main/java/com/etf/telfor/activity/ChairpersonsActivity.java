...
/*
    ...
    public void getSectionsByChairperson(int chairpersonId) {
        ...
        Cursor cursor = database.rawQuery(  "SELECT DISTINCT(section.section_id),section.title " +
                                                "FROM section, session " +
                                                "WHERE section.section_id=session.section_id AND chairperson_id=?",
                                                new String[]{String.valueOf(chairpersonId)});
        ...
        for (final Chairperson c : list) {
            ...
            cl.findViewById(R.id.imageViewSections).setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    getSectionsByChairperson(c.getChairpersonId());
                }
            });
